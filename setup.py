...
setup(
    name = 'django-representations',
    version = "0.1",
    description = 'A set of template tags that helps in displaying objects various ways.',
    long_description = README,
    install_requires = REQUIREMENTS,
    author = 'Mathijs de Bruin',
    author_email = 'mathijs@mathijsfietst.nl',
    url = 'http://github.com/dokterbob/django-representations',
